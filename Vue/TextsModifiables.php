...
<?php $vue=getQuiSommesNous();?>
    ...
    <label for="conditions">Modifier les conditions générales d'utilisation </label> :<br/>
    <?php $vue=getConditions();?>
    <textarea name="conditions" rows="10" cols=200"><?php echo($vue);?></textarea>
