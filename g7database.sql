...
--
-- Client :  127.0.0.1
-- Généré le :  Ven 12 Mai 2017 à 10:12
...
CREATE TABLE `adress_home` (
  ...
  `etage_min` int(11) NOT NULL,
  `etage_max` int(11) NOT NULL,
...
INSERT INTO `adress_home` (`IDADRESSE`, `IDHOME`, `street_num`, `street`, `city`, `zipcode`, `country`, `floor_num`, `etage_min`, `etage_max`, `room_num`, `capteur_num`, `area`, `IDUSER`) VALUES
(1, 1, 42, 'aaa', 'Paris', 75007, 'France', 4, 0, 0, 11, 30, 250, 1),
(2, 2, 2, 'Place Claude Monet', 'Buc', 78530, 'France', 3, 0, 0, 13, 40, 250, 4);
