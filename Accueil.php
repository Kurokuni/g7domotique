...
<html lang="fr">
    ...
    <body>
        <a href="index.php">
            <img src="Images/Logo DomIsep.PNG" style="width:150px;height:100px;" alt="Logo DomIsep"/>
        </a>
            <?php include 'Header.php';?>
            <img align="middle" src ="Images/Accueil.jpg" style="width:100%;height:600px;" alt="Photo Accueil"/>
        <h2>
            <br/> <br/> <br/>
            <p style="color:red" id="QuiSommesNous" align="center"> <strong> Qui sommes nous ? </strong></p>
