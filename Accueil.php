    ...
    <div class ="loginForm">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action='Controleur/Controleur_Connexion.php' method='post' accept-charset="UTF-8" role="form">
                    <fieldset>
                        ...
                        <a align="right" href="Vue/Vue_Inscription.php">Créer un compte</a>
                        <a align="right" href="Vue/VueMotDePasseOublier.php">Mot de passe oublié</a>
                    </fieldset>
                </form>
            </div>
        </div>
